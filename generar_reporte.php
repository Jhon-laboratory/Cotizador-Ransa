...
function generarExcelTarifasEspeciales($registro, $tarifas_especiales, $cliente_info) {
    ...
    // ========== HOJA 2: DETALLES COMPLETOS (IGUAL QUE TARIFAS NORMALES) ==========
    ...
    $sheet2->setCellValue('A1', 'SERVICIO DE ALMACENAJE Y MANIPULACIÓN - TARIFAS ESPECIALES');
    ...
    $sheet2->setCellValue('B4', 'ESPECIAL');
    ...
    header('Content-Disposition: attachment; filename="Tarifas_Especiales_' . preg_replace('/[^a-zA-Z0-9_-]/', '_', $cliente_info) . '_' . date('Ymd_His') . '.xlsx"');
...
<body>
    ...
    <div class="contenedor-pagina pagina1">
        <div class="encabezado-especial">
            TARIFAS ESPECIALES <span class="badge-especial">MODO ESPECIAL</span>
        </div>
        ...
        <div class="info-cliente">
            ...
            <div><strong>Modo:</strong> ESPECIAL</div>
        </div>
            ...
            <tbody>
                ...
                <tr class="<?php echo $clase_fila; ?>">
                    ...
                    <td align="right" style="font-weight: bold; color: #27ae60;">
                        $ <?php echo htmlspecialchars($tarifa['costo'] ?? '0,00'); ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        ...
        <div class="notas-especiales">
            ...
            <p><strong>⚡ Nota3.-</strong> Las tarifas especiales son personalizadas según las necesidades específicas del cliente</p>
        </div>
        
        <div class="footer">
            Página 1 de 3 | Sistema de Cotización de Tarifas Especiales
        </div>
    </div>
    
    <!-- === PÁGINA 2: DETALLES COMPLETOS (PARTE 1) === -->
    <div class="contenedor-pagina pagina2">
        <div class="encabezado-especial" style="background: linear-gradient(135deg, #3498db, #2980b9);">
            SERVICIO DE ALMACENAJE Y MANIPULACIÓN - TARIFAS ESPECIALES
        </div>
        ...
        <div style="margin-bottom: 20px; padding: 10px; background: #e8f4f8; border-radius: 5px;">
            ...
            <strong>Modo:</strong> <span style="color: #009A24; font-weight: bold;">ESPECIAL</span>
        </div>
    ...
    <!-- === PÁGINA 3: DETALLES COMPLETOS (PARTE 2) === -->
    <div class="contenedor-pagina pagina3">
        ...
        <div style="margin-top: 30px; padding: 15px; background: linear-gradient(135deg, #009A24, #00D12F); border-radius: 5px; text-align: center;">
            ...
            <span style="color: white;">
                Este documento contiene las 46 especificaciones completas del servicio de almacenaje, organizadas en 6 categorías principales.
                Las tarifas especiales mantienen el mismo alcance y especificaciones que las tarifas normales.
            </span>
        </div>
        
        <div class="footer">
            Página 3 de 3 | Documento generado el <?php echo $fecha_completa; ?> | © <?php echo date('Y'); ?> RANSA - Servicios Especiales
        </div>
    </div>
